...
const ArgusVault = (() => {
  ...
  return {
    ...
    // Generate vault config without activating — for profile creation
    // Returns config object only, doesn't touch storage or memory
    async generateConfig(passcode, type) {
      ...
      return { type, salt: toBase64(salt), verify };
    },
